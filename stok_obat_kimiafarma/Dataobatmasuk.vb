...
Public Class Dataobatmasuk
    ...
    Private Sub Dataobatmasuk_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call koneksivb()
        Call awal()
        Call bersih()
        Call tampil()
    ...
    Private Sub btnsimpan_Click(sender As Object, e As EventArgs) Handles btnsimpan.Click
        ...
        If ComboBox1.Text = "" Or TextBox5.Text = "" Or DateTimePicker3.Text = "" Or TextBox6.Text = "" Then
            ...
            bersih()
        Else
            cmd = New MySqlCommand("Select * from tbl_obatmasuk where Kode_Obat='" & ComboBox1.Text & "'", conn)
            ...
            If dr.HasRows Then
                ...
                Try
                    ...
                    sql = "insert into tbl_obatmasuk values('" & ComboBox1.Text & "','" & TextBox5.Text & "','" & DateTimePicker3.Value.ToString & "','" & TextBox6.Text & "')"
                    cmd = New MySqlCommand(sql, conn)
                    cmd.ExecuteNonQuery()
                    cmd.Dispose()
    ...
    Sub tampil()
        koneksivb()
        da = New MySqlDataAdapter("select * from tbl_obatmasuk order by Kode_Obat", conn)
        ds = New DataSet
        ds.Clear()
        da.Fill(ds, "tbl_obatmasuk")
        DataGridView1.DataSource = (ds.Tables("tbl_obatmasuk"))
        ...
        Else
            ...
            If respons = MsgBoxResult.Ok Then
                ...
                If dr.HasRows Then
                    conn.Close()
                    conn.Open()
                    sql = "Delete from tbl_obatmasuk where Kode_Obat='" & ComboBox1.Text & "'"
                    cmd = New MySqlCommand(sql, conn)
                    Try
                        cmd.ExecuteNonQuery()
